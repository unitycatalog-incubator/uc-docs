...
description: Learn how to integrate Anthropic's Claude models with Unity Catalog to build powerful AI applications, including function calling, tool usage, and advanced prompt engineering.
---
