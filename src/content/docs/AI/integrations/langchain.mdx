...
description: Discover how to leverage LangChain with Unity Catalog to build powerful AI applications, including chain construction, agent creation, and advanced prompt engineering techniques.
---
