...
description: Learn how to integrate LlamaIndex with Unity Catalog to leverage UC functions as tools in your LlamaIndex applications, including setup instructions, prerequisites, and code examples.
---
