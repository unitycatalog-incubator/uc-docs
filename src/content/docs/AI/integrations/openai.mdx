...
description: Learn how to integrate OpenAI models with Unity Catalog to build powerful AI applications, including function calling, tool usage, and advanced prompt engineering.
---
