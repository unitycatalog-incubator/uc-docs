...
description: Learn how to integrate Unity Catalog with AI frameworks and tools, manage GenAI functions, and leverage UC's governance capabilities for AI applications
---
...
Embark on your journey with Unity Catalog AI by following our [Quickstart Guide](/getting-started/quickstart). This guide will walk you through the essential steps of installing the library, setting up your environment, and creating and executing UC Functions. Whether you're using an open-source UC server or a Databricks-managed UC, our quickstart ensures you can get up and running swiftly.

---

## Integrations

Unity Catalog AI integrates with a range of GenAI frameworks to enhance your AI applications. Explore our [Integrations Page](/ai/integrations/overview) to discover detailed guides and example notebooks for each supported framework.
