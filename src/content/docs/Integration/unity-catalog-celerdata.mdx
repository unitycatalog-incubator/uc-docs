...
description: Learn how to integrate CelerData Cloud BYOC with Unity Catalog to query data using CelerData's high-performance lakehouse query engine while maintaining unified governance and access control through Unity Catalog
---
