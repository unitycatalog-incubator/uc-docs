---
title: Unity Catalog Kuzu Integration
description: Learn how to integrate Kuzu with Unity Catalog to query and analyze Delta tables using Kuzu's graph database capabilities and Cypher query language
---
