...
description: Learn how to integrate Spice OSS with Unity Catalog to query Delta tables using Spice's unified SQL interface and portable runtime capabilities
---
...
<Steps>
1. Create a new directory and initialize a [Spicepod](https://docs.spiceai.org/reference/spicepod)
...
2. Add the Unity Catalog Connector
...
3. Configure Delta Lake tables object store credentials
