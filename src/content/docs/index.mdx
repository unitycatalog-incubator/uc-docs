...
<Image src={ucLogo} alt="UC Logo" width={400} height={50} />
...
<Image src={ucOverview} alt="Unity Catalog Overview" width={800} height={400} />

## Project Governance

Unity Catalog is proud to be hosted by the [LF AI & Data Foundation](https://lfaidata.foundation/projects).

<Image src={lfaidataLogo} alt="LF AI & Data Foundation Logo" width={200} height={200} />