...
<Image src={ucLogo} alt="UC Logo" class="full-width" />
...
<Image src={ucOverview} alt="Unity Catalog Overview" class="full-width" />

## Project Governance

Unity Catalog is proud to be hosted by the [LF AI & Data Foundation](https://lfaidata.foundation/projects).

<Image src={lfaidataLogo} alt="LF AI & Data Foundation Logo" class="full-width" />