...
import uc3Level from '../../assets/images/uc-3-level.png';
...
<Aside type="note">
To start Unity Catalog in Docker, refer to the [Docker Compose docs](docker_compose.md).
</Aside>
...
<Image src={uc3Level} alt="Unity Catalog 3 Level Structure" width={600} height={400} />

Here's an example Unity Catalog instance:

<Image src={ucExampleCatalog} alt="Unity Catalog Example Catalog" width={800} height={400} />
...
<Image src={ucUI} alt="Unity Catalog UI" width={800} height={400} />
...
<Image src={ucUIModels} alt="Unity Catalog UI Models" width={800} height={400} />
