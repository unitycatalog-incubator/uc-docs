---
title: Unity Catalog Authentication and Authorization
description: Learn how to configure authentication and authorization in Unity Catalog using external identity providers. Understand the authentication flow, set up external providers like Google Auth or Okta, and configure server settings for secure access control.
---

import { Tabs, TabItem, Aside, FileTree, Code, Steps } from "@astrojs/starlight/components";
import { Image } from 'astro:assets';
import ucAuthDiagram from '../../../assets/images/uc-auth-diagram-simplified.png';
import ucGoogleAuthBrowser from '../../../assets/images/uc_googleauth-browser-window.png';
import ucGoogleAuthUi from '../../../assets/images/uc_googleauth-ui.png';
import ucGoogleAuthUiEnabledServerDisabled from '../../../assets/images/uc_googleauth_ui-enabled_server-disabled.png';
import ucGoogleAuthUiDisabledServerEnabled from '../../../assets/images/uc_googleauth_ui-disabled_server-enabled.png';
...
<Image src={ucAuthDiagram} alt="Unity Catalog Authentication and Authorization Simplified" />
...
<Aside type="note" title="Unity Catalog UI supported Identity Authentication Providers">
...
[working with Unity Catalog Tables with Spark](/integration/unity-catalog-spark) using the unauthenticated
...
With this set, now you can continue your [Using Spark SQL to query Unity Catalog schemas and tables](/integration/unity-catalog-spark#using-spark-sql-to-query-unity-catalog-schemas-and-tables)
and [Running CRUD Operations on a Unity Catalog table](/integration/unity-catalog-spark#running-crud-operations-on-a-unity-catalog-table)
...
when you - in this example - previously [configured Google as the Identity Provider](/server/google-auth).
...
<Image src={ucGoogleAuthBrowser} alt="UC Google Auth Browser Window" />
...
<Image src={ucGoogleAuthUi} alt="UC Google Auth UI" />
...
<Image src={ucGoogleAuthUiEnabledServerDisabled} alt="UC Google Auth UI Enabled Server Disabled" />
...
<Image src={ucGoogleAuthUiDisabledServerEnabled} alt="UC Google Auth UI Disabled Server Enabled" />
