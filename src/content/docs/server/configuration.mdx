---
title: Unity Catalog Server Configuration
description: Learn how to configure and run the Unity Catalog server locally or in the cloud. Understand server startup requirements, configuration options, and basic usage including port configuration.
---
...
<Aside type="note" title="Running Unity Catalog Server on a specific port">
