...
description: Learn how Unity Catalog manages users and privileges, including user authentication, authorization, and privilege management. Understand how to create users, grant privileges, and work with admin accounts.
---
