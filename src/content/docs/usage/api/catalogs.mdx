...
<Code code={`{'name': 'unity',
 ...
 'updated_at': None,
 'updated_by': None,
 'id': 'f029b870-9468-4f10-badc-630b41e5690d'}`} lang="python" />
...
<Code code={`{'name': 'my_new_catalog',
 ...
 'updated_by': None,
 'id': '08601e1a-d940-419c-8bfe-7667ea9bcab8'}`} lang="python" />
...
<Code code={`{'name': 'my_new_catalog',
 ...
 'updated_by': None,
 'id': 'aeb72f8b-9d4b-4128-be97-639e914e785c'}`} lang="python" />
...
if response.status_code == 200:
    ...
    print("❌ Failed to delete catalog:", response.text)`} lang="python" />

This should return:

<Code code="✅ The catalog was successfully deleted." lang="console" />
