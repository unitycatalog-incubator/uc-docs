...
<Aside type="note">
Change the path to "s3://my-bucket/..." for s3 tables
</Aside>

This will return:

<Code code={`{'name': 'my_new_table',
 'catalog_name': 'unity',
 'schema_name': 'default',
 'table_type': 'EXTERNAL',
 'data_source_format': 'DELTA',
 ...
 'updated_by': None,
 'table_id': '53b8c66f-01c8-41bc-a762-edbe20aa7813'}`} lang="python" />
