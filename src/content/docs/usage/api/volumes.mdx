...
<Code code={`{'catalog_name': 'unity',
 ...
 'full_name': 'unity.default.json_files'}`} lang="python" />
...
<Aside type="note">
Use "s3://my-bucket/..." for s3 tables
</Aside>
...
<Code code={`{'catalog_name': 'unity',
 ...
 'full_name': 'unity.default.my_new_volume'}`} lang="python" />
...
response = requests.delete(URL)`} lang="python" />
