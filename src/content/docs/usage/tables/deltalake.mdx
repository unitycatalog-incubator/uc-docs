---
title: Delta Lake
description: Learn how to work with Delta Lake tables in Unity Catalog. Understand basic operations like listing tables, viewing metadata, and interacting with Delta Lake formatted data.
---
...
Take a look at the [Integrations](/integration/unity-catalog-duckdb) page for more examples of working with Delta tables stored in Unity Catalog.
