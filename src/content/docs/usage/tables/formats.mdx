---
title:  Table Formats
description: Learn how to work with different table storage formats in Unity Catalog, including Parquet, ORC, JSON, CSV, Avro, and TEXT. Understand how to create and manage tables in various formats, along with their advantages and limitations.
---
...
<Aside type="note" title="Setting your /path/to/storage">
