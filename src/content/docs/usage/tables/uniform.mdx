---
title: Unity Catalog with UniForm tables
description: Learn how to work with UniForm tables in Unity Catalog - Delta Lake tables with dual Delta and Iceberg metadata that enable cross-engine compatibility. Understand how to set up and query UniForm tables through the Iceberg REST Catalog interface.
---
